"""boardgame_library URL Configuration
...
urlpatterns = [
                  ...
                  path('password_change/', PasswordChangeView.as_view(form_class=PasswordChangeFormExtend),
                       name='password_change'),
                  path('password_reset/', PasswordResetView.as_view(form_class=PasswordResetFormExtend),
                       name='password_reset'),
